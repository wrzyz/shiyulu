...
const moodLetterTemplates={
  '治愈':[{text:'今天先照顾自己，再照顾世界。',note:'你已经走了很远，今晚可以慢一点。'},{text:'不必马上好起来，先允许自己被接住。',note:'难受的时候，喝一杯热的，比勉强微笑更重要。'},{text:'你值得被温柔对待，包括被自己。',note:'今天没有做到完美，也依然很了不起。'}],
  '勇气':[{text:'害怕没有让你停下，这已经足够勇敢。',note:'你可以发抖，也可以继续走。'},{text:'重新开始，不需要等到不害怕。',note:'把第一步迈出去，剩下的路会慢慢变亮。'}],
  '希望':[{text:'天会亮，你也会重新笑起来。',note:'最暗的时候，先替自己点一盏小灯。'},{text:'只要还在走，就没有真正的坏结局。',note:'慢一点也没关系，你正在靠近天亮。'}],
  '孤独':[{text:'孤单不是没人来，是你终于开始陪自己。',note:'一个人也要把今天好好过完。'},{text:'安静不是空，是和自己相处的时刻。',note:'今晚不用向谁解释，你只需要好好待着。'}],
  '夜晚':[{text:'把心事交给月亮，明天再继续赶路。',note:'今晚你不需要解决所有问题。'},{text:'晚安不是认输，是给自己留到明天的力气。',note:'闭上眼，让今天先结束。'}],
  '成长':[{text:'你不必一下子变好，变好一点也是变好。',note:'每一次重新站起来，都算数。'},{text:'允许自己笨拙，是变好的开始。',note:'你正在学会的，不只是答案，还有耐心。'}],
  '亲情':[{text:'有些爱不常说出来，却一直在身后。',note:'今天也记得，有人会等你回家吃饭。'},{text:'被惦记，是这世上很温柔的确认。',note:'就算你暂时没有回家，也有人想你。'}],
  '生活':[{text:'把平凡的日子过好，就是了不起的事。',note:'好好吃饭、好好睡觉，也是一种勇敢。'},{text:'生活很难，但你也接住了很多。',note:'今天的小事，也值得被记下来。'}],
  '爱情':[{text:'爱是靠近，也是把彼此放在心上。',note:'想念不必用力，温柔地记得就好。'},{text:'真心不是轰轰烈烈，是把日常过成陪伴。',note:'你值得一段彼此都愿意走近的关系。'}],
  '友谊':[{text:'有人愿意听你碎碎念，就是很暖的事。',note:'不必一直坚强，可以告诉朋友你需要陪伴。'},{text:'真正的朋友，会看见你的眼泪。',note:'今天也可以主动说一句：我想你了。'}],
  'default':[{text:'你不需要立刻解决所有事，先让自己喘口气。',note:'这一秒，你被这句话接住了。'},{text:'日子不会一直这么重，你会慢慢有力量。',note:'今天愿意停下来看这句，已经很温柔。'}]
};
let heroPick=null;
let speech=null;
